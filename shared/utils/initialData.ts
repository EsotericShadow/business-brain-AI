...
import type { DirectoryItem, Plan, TokenPack, User, Chat, Email, MediaItem, CalendarEvent } from '../types/index.js';
...
export const initialDirectory: { [id: string]: DirectoryItem } = {
  'root': {
    id: 'root',
    type: 'directory',
    name: 'Business Brain',
